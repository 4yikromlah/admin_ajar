...
export default function Laporan({ siswaList, nilaiList, presensiList, pembelajaranList, settings }: LaporanProps) {
  ...
  const handlePrint = () => {
    try {
      ...
      if (isInIframe) {
        // Karena browser sering memblokir window.print() dari dalam sandboxed iframe,
        // berikan pilihan pintar kepada pengguna untuk langsung mengunduh PDF yang sesuai dengan tab aktif.
        const confirmPrint = window.confirm(
          "Anda sedang membuka aplikasi di dalam bingkai pratinjau (preview iframe).\n\n" +
          "Untuk alasan keamanan, browser sering kali memblokir cetak langsung dari dalam bingkai ini.\n\n" +
          "Apakah Anda ingin mengunduh file PDF laporan ini untuk dicetak dari komputer Anda?"
        );
      ...
      // Fallback ramah jika terjadi error tak terduga
      alert(
